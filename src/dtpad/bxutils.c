...
static Boolean REGBXCONVERTERS = False;
...
#if !defined(NeedFunctionPrototypes) || !defined(__cplusplus)
    (void)data;  /* Makes compiler happy with unused parameters */
#endif
        ...
        GRA(Boolean *, success)
{
    ...
    char                rptr[16];       /* temporary space tp hold return ptr */

#if !defined(NeedFunctionPrototypes) || !defined(__cplusplus)
    (void)to_size;  /* Makes compiler happy with unused parameters */
#endif
...
#if !defined(NeedFunctionPrototypes) || !defined(__cplusplus)
    (void)p;  /* Makes compiler happy with unused parameters */
    (void)dispatch;
#endif
...
GRA(BxXpmAttributes *, attributes)
{
    ...
    Colormap colormap;
    unsigned int depth;
    BxXpmColorSymbol *colorsymbols = 0;
